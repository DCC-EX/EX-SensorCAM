...
//Camera pin definitions for your S3 CAM board (OV2640 / OV3660)
#elif defined(CAMERA_MODEL_WROOM_S3)
#define PWDN_GPIO_NUM    -1     // PWDN (see D7 below)
#define RESET_GPIO_NUM   -1     // Not connected
#define XCLK_GPIO_NUM    15     // XCLK
...
#define Y8_GPIO_NUM      17     // D6  shared
#define Y9_GPIO_NUM      16     // D7  (shared with PWDN on some clones) Some clones use 6 or 16
